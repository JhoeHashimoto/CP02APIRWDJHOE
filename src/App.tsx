...
import UserA from "./componentes/UserA";
import UserF from "./componentes/UserF";

function App(){
  return (
    <BrowserRouter>
    <div className="flex flex-col min-h-screen">
      <header className="bg-gradient-to-r from-blue-900 to-blue-600 text-6xl font-bold" >AXIOS 19/04/2024</header>
        <nav>
          <ul className="flex justify-center space-x-4 flex-grow bg-blue-500 text-orange p-4 text-3xl semi-bold">
            ...
            <li><Link to='/userf' className="hover:text-blue-800 font-semibold">UserF</Link></li>
            <li><Link to='/usera' className="hover:text-blue-800 font-semibold">UserA</Link></li>
          </ul>
        </nav>
        <main className="flex-grow bg-blue-300">
          <Routes>
            ...
            <Route path="/userf" element={<UserF/>}></Route>
            <Route path="/usera" element={<UserF/>}></Route>
          </Routes>
        </main>
